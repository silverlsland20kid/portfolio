export const workProjects = {
  ...
  Subway: {
    ...
    description: `
      ...
      강의를 기반으로 제작한 학습용 프로젝트로, 
      UI 구조 이해와 기능 구현을 중심으로 실습하며 코드를 직접 작성했습니다.<br />
      <br />
      전체 레이아웃은 실제 브랜드 무드를 유지하면서도,
      React 기반의 컴포넌트 구조를 통해 유지보수성과 확장성을 높였습니다.<br />
      또한 반응형 레이아웃과 스크롤/호버 인터랙션을 세밀하게 조정하는 방법도 모색했습니다.<br />
      이번 프로젝트는 디자인 시스템 분석, 브랜드 톤 앤 매너 이해,
      UI 구조화,<br /> 실제 서비스 UX 흐름을 코드로 풀어내는 과정 등을 학습하고 정리하는 데 중점을 둔 작업입니다.
    `,
    year: "2025",
    ...
    contribution:
      "UI 구조 분석 · React 컴포넌트 구조화 · 시맨틱 마크업 · 인터랙션 구현 100%",
    github:
...
<br />
      각 섹션의 배경 테마(밝음/어두움)에 따라 헤더 스타일 자동 변경되는 구조를 분석하며, <br />
      자회사의 아이덴티티를 느낄 수 있는 브랜드 톤 앤 매너 이해,<br /> 여러 애니메이션 css를 학습하고 정리하는 데 중점을 둔 작업입니다.
    `,
    year: "2025",
    role: "Publishing",
    duration: "약 2주",
  ...
  todoapp: {
    ...
    skills: ["HTML5", "CSS", "JavaScript(ES6+)", "React"],
    contribution:
      "UI 구조 분석 · React 컴포넌트 구조화 · 시맨틱 마크업 · 반응형 처리 100%",
    github:
  ...
  Daewoong: {
    ...
    description: `
      ...
      개인 작업 · 페이지 구조 분석, 컴포넌트 설계, 레이아웃 퍼블리싱, 상태 관리 및 인터랙션 구현까지 전 과정 100% 담당했습니다.<br />
      제약회사인만큼 정보를 사용자에게 많이 전달해야 하는점을 고려하여 swiper 를 통해 클론코딩으로 제작해보았으며,<br />
    ...
    contribution: "UI 구조 분석 · 시맨틱 마크업 · 인터랙션 구현 100%",
    github:
  ...
  Dasoni: {
    ...
    description: `
      ...
      개인 작업 · 페이지 구조 분석, jQuery 기반 인터랙션 구현, Swiper 슬라이드 구성, 레이아웃 퍼블리싱 및 UI 흐름 정리를 100% 직접 수행했습니다.<br />
      각 섹션은 스크롤 위치를 계산하여 요소별로 순차 애니메이션이 적용되도록 jQuery 기반의 스크롤 인터랙션을 직접 구성했습니다.<br />
  ...
  KVILLAGE: {
    ...
    description: `
      K.VILLAGE 회사 내의 실무 참여 프로젝트로 여러 브랜드 (k2, eider 등) 전시/이벤트를 소개하는 원페이지 퍼블리싱을 담당했습니다.<br />
      시안 기반 퍼블리싱, 반응형 레이아웃, 슬라이드 구성, 스크롤 인터랙션 구현 등 퍼블리싱 전반을 주도적으로 수행했습니다.<br />
  ...
  Handsome: {
    ...
    description: `
      ...
      실무 프로젝트로, 디자인 시안 기반 퍼블리싱·반응형·슬라이드 인터랙션 구현을 담당했습니다.<br />
      디자인 시안과 컴포넌트 가이드를 바탕으로 시맨틱 마크업과 반응형 레이아웃을 구현했고,<br />
      상품 슬라이드, 앵커 네비게이션, 스크롤 인터랙션 등을 크로스브라우징 기준에 맞춰 작업했습니다.<br />
      <br />
      회사 프로젝트 특성상 실제 소스 코드는 비공개이며, 퍼블리싱 담당 영역과 기여도를 중심으로 설명하고 있습니다.<br />
  ...
  kolonmall: {
    ...
    description: `
      ...
      실무 프로젝트로, 디자인 시안 기반 퍼블리싱·반응형·슬라이드 인터랙션 구현을 담당했습니다.
      디자인 시안과 컴포넌트 가이드를 바탕으로 시맨틱 마크업과 반응형 레이아웃을 구현했고,<br />
      상품 슬라이드, 앵커 네비게이션, 스크롤 인터랙션 등을 크로스브라우징 기준에 맞춰 작업했습니다.<br />
      <br />
      회사 프로젝트 특성상 실제 소스 코드는 비공개이며, 퍼블리싱 담당 영역과 기여도를 중심으로 설명하고 있습니다.<br />
  ...
  Agencycreativeaudio: {
    ...
    description: `
      GSAP 기반의 애니메이션과 스크롤 인터랙션 구현에 초점을 맞춘 강의를 기반으로 제작한 학습용 클론코딩 프로젝트입니다.<br />
    ...
    contribution:
      "UI 구조 분석 · 인터랙션 구현 · 시맨틱 마크업 · 반응형 처리 100%",
    github:
  ...
  Namdomall: {
    ...
    description: `
      ...
      실제 운영 환경 중심의 실무 퍼블리싱 70% 정도를 담당했습니다.<br />
  ...
  Yeongammall: {
    ...
    description: `
      ...
      컴포넌트 가이드를 바탕으로 시맨틱 마크업과 반응형 레이아웃을 작업했습니다.<br />
      상품 슬라이드, 앵커 네비게이션, 스크롤 인터랙션 등을 크로스브라우징 기준에 맞춰 작업하였으며,<br />
      실제 운영 환경 중심의 실무 퍼블리싱 90% 정도를 담당했습니다.<br />
  ...
  Fitz: {
    ...
    description: `
      ...
      평소에 관심있었던 이어폰 기기들을 생각하여 자체 브랜딩 및 홈페이지를 제작해보았으며,<br />
      초기 시안 기반 마크업부터 반응형, UX 조정, 슬라이드/네비게이션 구현, 운영 중 기능 오류 수정까지 전 과정을 100% 담당했습니다.<br />
