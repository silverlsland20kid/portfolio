...
<br />
  ...
  Daewoong: {
    ...
    description: `
      ...
      개인 작업 · 페이지 구조 분석, 컴포넌트 설계, 레이아웃 퍼블리싱, 상태 관리 및 인터랙션 구현까지 전 과정 100% 담당했습니다.
  ...
  Dasoni: {
    ...
    description: `
      ...
      개인 작업 · 페이지 구조 분석, jQuery 기반 인터랙션 구현, Swiper 슬라이드 구성, 레이아웃 퍼블리싱 및 UI 흐름 정리를 100% 직접 수행했습니다.
  ...
  KVILLAGE: {
    ...
    description: `
      ...
      시안 기반 퍼블리싱, 반응형 레이아웃, 슬라이드 구성, 스크롤 인터랙션 구현 등 퍼블리싱 전반을 주도적으로 수행했습니다.
  ...
  Namdomall: {
    ...
    description: `
      ...
      실제 운영 환경 중심의 실무 퍼블리싱 70% 정도를 담당했습니다.
  ...
  Yeongammall: {
    ...
    description: `
      ...
      컴포넌트 가이드를 바탕으로 시맨틱 마크업과 반응형 레이아웃을 작업했습니다.<br />
      상품 슬라이드, 앵커 네비게이션, 스크롤 인터랙션 등을 크로스브라우징 기준에 맞춰 작업하였으며,<br />
      실제 운영 환경 중심의 실무 퍼블리싱 90% 정도를 담당했습니다.
